 ...
 */
    ...
    //if number is even or odd and alerts user
    ...
    //if number is positive or negative and alerts user
    var isPositive = function(num) {
    if (num > 0) {
        alert('The number ' +num+ ' is positive, great')
    } else {
        alert('The number ' +num+ ' is negative, great')
    }
}
